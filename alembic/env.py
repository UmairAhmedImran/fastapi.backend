...
from app.models import Base # want our sqlalchemy models so have to import Base from models so it csn read models if we do it directly it is not going to read the models
